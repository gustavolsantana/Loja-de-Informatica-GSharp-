...
namespace GSharp
{
    class classMarca
    {
        ...
        {
            string query = "SELECT id_marca 'ID', nome 'Marca', observacao 'Observacao', data_cadastro 'Data do Cadastro' FROM marca WHERE status = 1 AND nome LIKE '" + nomei + "%' ORDER BY nome;";
        ...
        {
            string query = "SELECT id_marca 'ID', nome 'Marca', observacao 'Observacao', data_cadastro 'Data do Cadastro' FROM marca WHERE status = 1 AND nome LIKE '%" + nomec + "%' ORDER BY nome;";
        ...
        {
            string query = "SELECT id_marca 'ID', nome 'Marca', observacao 'Observacao', data_cadastro 'Data do Cadastro' FROM marca WHERE status = " + status + " ORDER BY nome;";
        ...
        {
            //EXIBIR TODOS OS DADOS DO Marca ESCOLHIDO PELO USUÁRIO NA GRID DE CONSULTA
        ...
        {
            string query = "UPDATE marca SET nome = '" + nome + "', status = " + status + ", observacao = '" + observacao + "' WHERE id_marca = " + id_marca + ";";
