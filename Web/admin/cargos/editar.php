            ...
            <main class="ml-auto col-lg-10 px-md-4">
                ...
                <div class="container mt-5">
                    ...
                    if (isset($_GET['id_cargo']) && $_GET['id_cargo'] != '') {
                        ...
                        $sql_editar = "SELECT * FROM cargo WHERE id_cargo = $codigo";
                        $query_editar = mysqli_query($conexao, $sql_editar);
                        $cargo = mysqli_fetch_assoc($query_editar);
                    ?>
                                ...
                                <form action="acoes.php" method="post">
                                    <div class="form-row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="cargo" id="cargo" class="form-control" required maxlength="60" required value="<?php echo $cargo['nome'] ?>">
                                        </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            ...
                                            <textarea name="observacao" id="observacao" class="form-control" maxlenth="100"><?php echo $cargo['observacao'] ?></textarea>
                                        </div>
