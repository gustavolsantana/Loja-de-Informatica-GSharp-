            ...
            <main class="ml-auto col-lg-10 px-md-4">
                ...
                <div class="container mt-5">
                    ...
                    if (isset($_GET['id_marca']) && $_GET['id_marca'] != '') {
                        ...
                        $sql_editar = "SELECT * FROM marca WHERE id_marca = $codigo";
                        $query_editar = mysqli_query($conexao, $sql_editar);
                        $marca = mysqli_fetch_assoc($query_editar);
                    ?>
                                ...
                                <form action="acoes.php" method="post">
                                    <div class="form-row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="marca" id="marca" class="form-control" required maxlength="60" required value="<?php echo $marca['nome'] ?>">
                                        </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            ...
                                            <textarea name="observacao" id="observacao" class="form-control" maxlenth="100"><?php echo $marca['observacao'] ?></textarea>
                                        </div>

                                        <div class="col-12 mt-3">
                                            <input type="hidden" name="editar" value="editar_marca">
