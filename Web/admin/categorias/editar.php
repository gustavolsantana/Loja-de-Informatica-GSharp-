            ...
            <main class="ml-auto col-lg-10 px-md-4">
                ...
                <div class="container mt-5">
                    ...
                    if (isset($_GET['id_categoria']) && $_GET['id_categoria'] != '') {
                        ...
                        $sql_editar = "SELECT * FROM categoria WHERE id_categoria = $codigo";
                        $query_editar = mysqli_query($conexao, $sql_editar);
                        $categoria = mysqli_fetch_assoc($query_editar);
                    ?>
                                ...
                                <form action="acoes.php" method="post">
                                    <div class="form-row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="categoria" id="categoria" class="form-control" required maxlength="60" required value="<?php echo $categoria['nome'] ?>">
                                        </div>
                                        ...
                                        <div class="col-12 mt-3">
                                            ...
                                            <textarea name="observacao" id="observacao" class="form-control" maxlenth="100"><?php echo $categoria['observacao'] ?></textarea>
                                        </div>
