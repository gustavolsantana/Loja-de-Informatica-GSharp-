                        ...
                        ?>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <form action="" method="get">
                                            <input type="search" name="pesquisa" id="pesquisa" class="form-control" placeholder="Pesquise por categoria..." value="<?php echo $pesquisa ?>">
                                        </form>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="editar.php?id_categoria=<?php echo $categoria["id_categoria"] ?>" class="btn btn-outline-success btn-sm">
                                                        <i class="bi bi-pencil"></i>
                                                    </a>
                                                    <form action="acoes.php" method="post" class="d-inline">
                                                        <button type="submit" class="btn btn-outline-danger btn-sm" title="Excluir" name="excluir_categoria" value="<?php echo $categoria['id_categoria'] ?>" onclick="return confirm('Você tem certeza que deseja excluir esta categoria?')">
