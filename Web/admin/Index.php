  ...
  <main class="form-signin">
    ...
    <div class="pt-2">
      ...
      if (isset($_SESSION['loginErro'])) {
        // Usamos 'text-danger' para vermelho
        echo '<span class="text-danger">' . $_SESSION['loginErro'] . '</span>';
        unset($_SESSION['loginErro']);
      }

      if (isset($_SESSION['loginVazio'])) {
        echo '<span class="text-danger">' . $_SESSION['loginVazio'] . '</span>';
        unset($_SESSION['loginVazio']);
      }

      if (isset($_SESSION['naoAutorizado'])) {
        echo '<span class="text-danger">' . $_SESSION['naoAutorizado'] . '</span>';
        unset($_SESSION['naoAutorizado']);
      }

      if (isset($_SESSION['logOff'])) {
        // Usamos 'text-success' para a cor verde de sucesso
        echo '<span class="text-success">' . $_SESSION['logOff'] . '</span>';
