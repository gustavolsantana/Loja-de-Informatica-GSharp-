                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="id_cargo" id="id_cargo" class="form-control" required>
                                            ...
                                            $sql = "SELECT id_cargo, nome FROM cargo WHERE status = 1";
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <input type="text" name="salario" id="salario" class="form-control" data-mask="000000,00" data-mask-reverse=true>
                                    </div>
